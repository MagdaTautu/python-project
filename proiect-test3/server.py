        ...
        while True:
                ...
                if guess.isdigit():
                    ...
                    if guess == num_to_guess:
                        client_socket.sendall(f"Correct! You guessed it! GAME OVER! Final score: {clients_score[client_number]}".encode())
                ...
                while True:
                    if client_number == 1:
                        ...
                        if guess.isdigit():
                            guess = int(guess)
                            if guess == num_to_guess:
                                client_sockets[client_number].sendall(f"Correct! You guessed it! GAME OVER! Final score: {clients_score[client_number]}".encode())
                                other_client = 1 - client_number
